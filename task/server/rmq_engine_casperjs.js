    ...
    ch.consume(queueName, function(msg) {
        ...
        if (msg !== null) {
            ...
            if (scriptExists) {
                ...
                // 执行脚本
                if (shell.exec('sudo docker exec -i 471b73abcc3a /alidata/server/node/bin/casperjs ' + path + ' ' + result.body.task_run_log_id + ' "' + result.body.url + '" --web-security=no', {async:true}).code !== 0) {
